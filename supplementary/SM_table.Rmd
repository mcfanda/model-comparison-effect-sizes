...
power collapsed across those population effect size values only (mean signed bias, mean
absolute bias, RMSE, and mean power gap, by model, sample size, and number of covariates
k), keeping
